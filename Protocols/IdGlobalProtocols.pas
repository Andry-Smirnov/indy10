...
const
  cTimeZones: array[0..244] of TimeZoneOffset = (
    ...
    (TimeZone:'HAA';  Offset:'-0300'), // Heure Avancйe de l'Atlantique - North America          {do not localize}
    (TimeZone:'HAC';  Offset:'-0500'), // Heure Avancйe du Centre - North America                {do not localize}
    (TimeZone:'HADT'; Offset:'-0900'), // Hawaii-Aleutian Daylight Time - North America          {do not localize}
    (TimeZone:'HAE';  Offset:'-0400'), // Heure Avancйe de l'Est - North America                 {do not localize}
    (TimeZone:'HAEC'; Offset:'+0200'), // Heure Avancйe d'Europe Centrale francised name for CEST {do not localize}
    (TimeZone:'HAP';  Offset:'-0700'), // Heure Avancйe du Pacifique - North America             {do not localize}
    (TimeZone:'HAR';  Offset:'-0600'), // Heure Avancйe des Rocheuses - North America            {do not localize}
    (TimeZone:'HAST'; Offset:'-1000'), // Hawaii-Aleutian Standard Time - North America          {do not localize}
    (TimeZone:'HAT';  Offset:'-0230'), // Heure Avancйe de Terre-Neuve - North America           {do not localize}
    (TimeZone:'HAY';  Offset:'-0800'), // Heure Avancйe du Yukon - North America                 {do not localize}
    ...
    (TimeZone:'MEHSZ';Offset:'+0300'), // Mitteleuropдische Hochsommerzeit - Europe              {do not localize}
    (TimeZone:'MEST'; Offset:'+0200'), // Middle European Saving Time Same zone as CEST          {do not localize}
    (TimeZone:'MESZ'; Offset:'+0200'), // Mitteleuroдische Sommerzeit - Europe                   {do not localize}
    (TimeZone:'MET';  Offset:'+0100'), // Middle European Time Same zone as CET                  {do not localize}
    (TimeZone:'MEZ';  Offset:'+0100'), // Mitteleuropдische Zeit - Europe                        {do not localize}
    ...
    (TimeZone:'RET';  Offset:'+0400'), // Rйunion Time                                           {do not localize}
