...
}
{
  ...
  Added property suggested by Henrick Hellstrцm (StreamSec) for checking a
...
type
  ...
  public
    ...
    property IsPeer : Boolean read fIsPeer write fIsPeer;
     {
Pasted from private corresponance from Henrick Hellstrцm - StreamSec http://www.streamsec.com
